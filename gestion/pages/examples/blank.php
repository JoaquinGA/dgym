...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Gestión | <?php echo($usuario); ?></title>
...
<!--=======================================================================================================-->
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            //Cargar página principal al entrar
            ...
            $('#menu_usuarios_gestion').click(function(){
                $('#contenedor').load('usuarios_gestion.php');
            });

            $('#menu_usuarios_historial').click(function(){
                $('#contenedor').load('usuarios_historial.php');
            });


            //Botón menu facturas
            $('#menu_facturas').click(function(){
                $('#contenedor').load('facturas.php');
            });
                            ...
                            if($permiso == "0"){
                                echo("
                                    ...
                                    <ul class='treeview-menu'>
                                        <li><a id='menu_usuarios_gestion'><i class='fa fa-angle-double-right'></i> Gestión</a></li>
                                        <li><a id='menu_usuarios_historial'><i class='fa fa-angle-double-right'></i> Historial</a></li>
                                    </ul>
                                    </li>
                                    ");
                            }
