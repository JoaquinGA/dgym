...
<html class="lockscreen">
    <head>
        <meta charset="UTF-8">
        <title>DGYM | Pantalla bloqueada</title>
            ...
            $(document).ready(function(){
                $('#boton_validar').click(function(){
                    ...
                    if(contrasenna != ""){
                        ...
                        var parametros = ("nombre="+"<?php echo($usuario) ?>"+"&contrasenna="+contrasenna);
        ...
        <div class="center">
            ...
            <div class="lockscreen-item">
                ...
                <div class="lockscreen-image">
                    <img src="../fotos_perfil/<?php echo($datos_usuario['foto']); ?>" alt="user image"/>
                </div>
                <!-- /.lockscreen-image -->
                ...
                <div class="lockscreen-credentials">
                    ...
                    <div class="input-group">
                        <input type="password" class="form-control" id="input_contrasenna" placeholder="Contraseña" />
                        <div class="input-group-btn">
                            <button class="btn btn-flat" id="boton_validar"><i class="fa fa-arrow-right text-muted"></i></button>
                        </div>
                    </div>
